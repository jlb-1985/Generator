...
function showFacts(event) {
  ...
  let context = "You are a factchecker expert and love to research facts and educate others about facts. Your mission is to generate a fact and describe it in maximum 4 lines. Make sure you follow the user instructions. Begin and end with a matching emoticon";
